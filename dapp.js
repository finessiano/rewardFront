...
mmEnable.onclick = async () => {
  ...
  const reward1remaining = await rewardProgramContract.methods.remainingRaceTicket().call;
  displayValue1.innerHTML = "Remaining: " + reward1remaining;

  var displayValue2 = document.getElementById('display-value2');
  const reward2remaining = await rewardProgramContract.methods.remainingVinyardTour().call;
  displayValue2.innerHTML = "Remaining: " + reward2remaining;

  var displayValue3 = document.getElementById('display-value3');
  const reward3remaining = await rewardProgramContract.methods.remainingRolex().call;
